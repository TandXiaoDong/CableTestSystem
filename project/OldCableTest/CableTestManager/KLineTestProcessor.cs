	...
	public class KLineTestProcessor
	{
		...
		public unsafe static string EncrypDisposeFunc(string sourceStr)
		{
			...
			try
			{
				...
				int srcLen = ptr - srcCharArray / sizeof(sbyte);
			...
			if (null != pMainPins && null != pSecPins)
			{
				...
				if (1 == nGroupType)
				{
					...
					if (0 < nSecPinCount2)
					{
						...
						int nGroupType2 = pMainPins - pSecPins / 4;
						int nSecDevID2 = nSecPinCount2;
						do
						{
							cmdMap.mMainDevPinNum = (nGroupType2 / 4)[pMainPins2];
				...
				else if (2 == nGroupType)
				{
					...
					if (0 < nSecPinCount)
					{
						do
						{
							cmdMap.mSecDevPinNum = i[pSecPins];
							int j = 0;
							if (0 < nMainPinCount)
							{
								do
								{
									cmdMap.mMainDevPinNum = j[pMainPins];
									this.mCurTestCmdMapArray.Add(cmdMap);
									j++;
								}
